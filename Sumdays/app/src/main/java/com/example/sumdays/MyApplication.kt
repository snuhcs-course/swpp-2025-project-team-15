...
import com.example.sumdays.test.TestConfig
import com.example.sumdays.test.TestDataSeeder
...
open class MyApplication : Application() {
    ...
    internal val database by lazy { AppDatabase.getDatabase(this) }
    ...
    override fun onCreate() {
        ...
        if (TestConfig.USE_TEST_WEEK_SUMMARIES) {
            CoroutineScope(Dispatchers.IO).launch {
                TestDataSeeder.seed(database.weekSummaryDao())
            }
        }
