...
class MemoDiffCallbackTest {
    ...
    fun areItemsTheSame_returnsTrueForSameId() {
        val oldItem =
            Memo(id = 10, content = "Old Content", timestamp = "T1", date = "D1", order = 1)
        // 내용이 달라도 ID가 같으면 true여야 합니다.
        val newItem =
            Memo(id = 10, content = "New Content", timestamp = "T2", date = "D2", order = 2)
    ...
    fun areContentsTheSame_returnsTrueForSameContent() {
        ...
        val oldItem =
            Memo(id = 5, content = "Same Content", timestamp = "T1", date = "D1", order = 1)
        val newItem =
            Memo(id = 5, content = "Same Content", timestamp = "T1", date = "D1", order = 1)
    ...
    fun areContentsTheSame_returnsFalseForDifferentContent() {
        val oldItem =
            Memo(id = 5, content = "Old Content", timestamp = "T1", date = "D1", order = 1)
        // 내용(content)이 변경됨
        val newItem =
            Memo(id = 5, content = "Updated Content", timestamp = "T1", date = "D1", order = 1)
